...
- **Un moniteur d'inscription** serait le vrai garde-fou : ce défaut a duré deux semaines sans que rien ne le signale. Une inscription de test hebdomadaire, avec lecture de la boîte, l'aurait vu le premier jour.
